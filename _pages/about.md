...
excerpt: "Neuroscientist | Biomedical Engineer"
author_profile: true
redirect_from: 
  - /about/
  - /about.html
  ...
  <div class="container">
    ...
    <div class="highlights-grid">
      ...
      <div class="highlight-card">
        ...
        <div class="highlight-content">
          <h3>New Paper in Nature Neuroscience</h3>
          <p>Longitudinal measures of monkey brain structure and activity through adolescence predict cognitive maturation</p>
          <span class="highlight-date">October 2025</span>
          <div class="project-links">
            <a href="https://www.nature.com/articles/s41593-025-02076-0" target="_blank" class="btn-readmore">
              <i class="fas fa-external-link-alt"></i> Read on Nature Neuroscience
            </a>
          </div>
        </div>
      </div>
...
<section class="stats-section">
  <div class="container">
    <h2 class="section-title">Achievements at a Glance</h2>
    <div class="stats-compact">
      ...
      <div class="stat-inline">
        ...
        <span class="stat-lbl">Years of Research</span>
      </div>
      <div class="stat-inline">
        <i class="fas fa-university"></i>
        <span class="stat-num">3</span>
        <span class="stat-lbl">Top Institutions</span>
      </div>
      <div class="stat-inline">
        <i class="fas fa-globe"></i>
        <span class="stat-num">2</span>
        <span class="stat-lbl">Languages (EN/CN)</span>
      </div>
    </div>
  </div>
</section>
